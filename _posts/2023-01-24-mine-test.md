...
.calculator-container { 
    width: 100vw; /* this width and height is specified for mobile devices by default */
    height: 100vh;
    margin: 0 auto;

    display: grid;
    grid-template-columns: repeat(1, 1fr); /* fr is a special unit; learn more here: https://css-tricks.com/introduction-fr-css-unit/  */
    grid-template-rows: 0.5fr repeat(1, 1fr);
    gap: 0px 0px;
}
